...
<meta name="theme-color" content="#563d7c">
  ...
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">豪哥商城后台管理</a>
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item ">
            <a class="nav-link " href="#" data-toggle="/brand/list">
...
<script type="text/javascript">
         $(function(){
        	 var array = $(".nav .nav-item .nav-link");
        	 console.log(array);
        	 $(array[0]).addClass("active");
        	 $("#main").load("/brand/list");
         })
